package com.vim.shadowsocks.ui;
...
import com.example.chaowei.search.R;
import com.google.zxing.integration.android.IntentIntegrator;
import com.google.zxing.integration.android.IntentResult;
import com.vim.shadowsocks.core.AppInfo;
import com.vim.shadowsocks.core.AppProxyManager;
import com.vim.shadowsocks.core.LocalVpnService;
import com.vim.shadowsocks.core.ProxyConfig;

import java.util.Calendar;

public class ShadowActivity extends AppCompatActivity implements
                ...
                .setPositiveButton(R.string.btn_ok, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (isValidUrl(ProxyUrl)) {
                            ...
                            Toast.makeText(ShadowActivity.this, R.string.err_invalid_url, Toast.LENGTH_SHORT).show();
                        }
                    }
                })
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.btn_ok, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            stopService(new Intent(ShadowActivity.this, LocalVpnService.class));
